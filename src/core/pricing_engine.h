...
API std::vector<float>  v_fd_price_host(
        const std::vector<float> &spots,
        const std::vector<float> &strikes,
        const std::vector<float> &tenors,
...
API std::vector<float> get_v_price_fd_cuda(
    const std::vector<float> &spots,
    const std::vector<float> &strikes,
    const std::vector<float> &tenors,
    const std::vector<float> &sigmas,
...
API float merlin_df_0_t_host(
    float t,
    const std::vector<float>& rates_curve,
    const std::vector<float>& rates_times);

API float merlin_df_t_T_host(
    float t,
    float T,
    const std::vector<float>& rates_curve,
    const std::vector<float>& rates_times);

API float merlin_forward_rate_host(
    float t,
    const std::vector<float>& rates_curve,
    const std::vector<float>& rates_times);
